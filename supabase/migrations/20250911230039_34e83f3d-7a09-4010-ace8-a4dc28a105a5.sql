-- ================================================================
-- TWISTED HEARTH FOUNDATION - COMPREHENSIVE DATABASE SCHEMA (FIXED)
...
-- Admin write policies for hints
CREATE POLICY "hunt_hints_admin_insert"
ON public.hunt_hints
FOR INSERT
TO authenticated
WITH CHECK (public.is_admin());

CREATE POLICY "hunt_hints_admin_update"
ON public.hunt_hints
FOR UPDATE
TO authenticated
...
CREATE POLICY "hunt_hints_admin_delete"
ON public.hunt_hints
FOR DELETE
TO authenticated
USING (public.is_admin());
...
CREATE POLICY "tournament_teams_admin_insert"
ON public.tournament_teams
FOR INSERT
TO authenticated
WITH CHECK (public.is_admin());

CREATE POLICY "tournament_teams_admin_update"
ON public.tournament_teams
FOR UPDATE
TO authenticated
USING (public.is_admin())
...
CREATE POLICY "tournament_teams_admin_delete"
ON public.tournament_teams
FOR DELETE
TO authenticated
USING (public.is_admin());
...
CREATE POLICY "vignettes_admin_insert"
ON public.vignettes
FOR INSERT
TO authenticated
WITH CHECK (public.is_admin());

CREATE POLICY "vignettes_admin_update"
ON public.vignettes
FOR UPDATE
TO authenticated
USING (public.is_admin())
...
CREATE POLICY "vignettes_admin_delete"
ON public.vignettes
FOR DELETE
TO authenticated
USING (public.is_admin());
