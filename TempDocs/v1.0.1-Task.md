Awesome — let’s knock these out in order. We’ll start with **Task 1: Supabase Auth + Persistence** and make RSVP, uploads, and comments require login, with a session that stays signed in through party night.
