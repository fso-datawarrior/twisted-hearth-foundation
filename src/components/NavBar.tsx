      ...
      <div className="container mx-auto px-[max(env(safe-area-inset-left),1rem)] pr-[max(env(safe-area-inset-right),1rem)] py-4">
        <div className="flex items-center justify-between nav-full:justify-center">
          ...
          <div className="flex nav-full:hidden items-center space-x-2 flex-shrink-0">
            <span className="font-subhead text-accent-gold text-sm uppercase tracking-wider hidden min-[520px]:block min-[520px]:nav-compact:!hidden truncate max-w-[120px]">
              {getCurrentPageName()}
            </span>
            ...
            <button
              className="nav-compact:hidden flex-shrink-0 p-2 text-ink hover:text-accent-gold transition-colors motion-safe border-0 outline-none focus:outline-none focus-visible:outline-none ring-0 focus:ring-0 focus-visible:ring-0 bg-transparent"
