    ...
    >
      <div className="container mx-auto px-[max(env(safe-area-inset-left),1rem)] pr-[max(env(safe-area-inset-right),1rem)] py-4">
        ...
        {isMenuOpen && (
          <div 
            id="mobile-menu"
            className="block nav-full:hidden absolute top-full right-4 w-80 max-w-[calc(100vw-2rem)] max-h-[calc(100vh-6rem)] overflow-y-auto overscroll-contain bg-bg-2/95 backdrop-blur-md border border-accent-purple/30 rounded-xl shadow-elegant animate-fade-in scrollbar-thin scrollbar-thumb-accent-gold/60 scrollbar-track-transparent"
          >
