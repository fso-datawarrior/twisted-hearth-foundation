...
export default function HeroVideo({
  ...
  return (
    <section 
      ref={sectionRef}
      className="relative isolate min-h-[80vh] supports-[height:100dvh]:min-h-[80dvh] overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black"
    ...
    >
      ...
      {/* Text overlay */}
      <div className="relative z-20 mx-auto flex max-w-5xl flex-col items-center px-4 pt-32 sm:pt-36 md:pt-40 pb-20 text-center text-ink">
