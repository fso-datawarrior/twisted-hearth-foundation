-- ============================================================
-- PATCH CR-01: Create Missing Vignette Database Schema
-- ============================================================
-- Priority: CRITICAL (Blocks Deployment)
-- Category: Database Schema
-- Risk: High (Database migration)
-- Testing: Verify all vignette operations work after migration
-- ============================================================

-- Step 1: Create past_vignettes table
...
-- Step 2: Add is_vignette_selected column to photos table
...
-- Step 6: Create get_active_vignettes RPC function
...
-- Step 7: Create toggle_vignette_selection RPC function
...
BEGIN
  ...
  -- Update photo vignette selection status
...
-- ============================================================
-- SELECT * FROM public.past_vignettes;
-- SELECT id, filename, is_vignette_selected FROM public.photos WHERE is_vignette_selected = true;
-- SELECT public.get_active_vignettes();
-- ============================================================
